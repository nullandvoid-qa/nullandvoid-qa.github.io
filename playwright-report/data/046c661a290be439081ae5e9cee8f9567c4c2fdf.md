...
- Name: happy-path.spec.js >> Null and Void QA happy path >> should expose the main homepage CTAs and reach the books library
- Location: tests/happy-path.spec.js:95:3
...
Expected pattern: /Formação QA/i
Received string:  "Bem-vindo à Null and Void"
Timeout: 5000ms

Call log:
  - Expect "toContainText" with timeout 5000ms
  - waiting for locator('.hero-title')
    14 × locator resolved to <h1 class="hero-title" data-i18n="hero.title">Bem-vindo à Null and Void</h1>
       - unexpected value "Bem-vindo à Null and Void"

```

```yaml
- heading "Bem-vindo à Null and Void" [level=1]
```
