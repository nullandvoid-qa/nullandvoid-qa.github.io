## Ficha Técnica
- Título: Cloud Native Patterns
- Autor: Cornelia Davis
- Ano: 2019
- Categoria: Tecnologia

## A Ideia Central
Padrões cloud-native: stateless, containerizado, orchestrado. Kubernetes gerencia escala, tolerância falta.

## Conceitos-Chave

**1. Conceito Principal**
Padrões cloud-native: stateless, containerizado, orchestrado. Fundação do tema.
