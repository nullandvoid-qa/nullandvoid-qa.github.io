...
## A Ideia Central
XP leva agile ao extremo: pair programming, TDD, CI, refactoring contínuo. Disciplina = liberdade.

## Conceitos-Chave

**1. Conceito Principal**
XP leva agile ao extremo: pair programming, TDD, CI, refactoring contínuo. Fundação do tema.
