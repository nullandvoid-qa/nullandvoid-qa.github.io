## Ficha Técnica
- Título: Working Effectively with Legacy Code
- Autor: Michael Feathers
- Ano: 2004
- Categoria: Tecnologia

## A Ideia Central
Código legacy desafia. Sem testes, mudança é arriscado. Técnicas extrair, testar, refactor.

## Conceitos-Chave

**1. Conceito Principal**
Código legacy desafia. Fundação do tema.
