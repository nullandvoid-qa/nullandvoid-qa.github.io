## Ficha Técnica
- Título: Mude Sua Vida em 30 Dias
- Autor: Jack Canfield
- Ano: 2011
- Categoria: Autoajuda

## A Ideia Central
30 dias para mudança: visão clara, eliminar velho, construir novo, medir, celebrar. Sistema = transformação.

## Conceitos-Chave

**1. Conceito Principal**
30 dias para mudança: visão clara, eliminar velho, construir novo, medir, celebrar. Fundação do tema.
