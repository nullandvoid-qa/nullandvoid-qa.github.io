## Ficha Técnica
- Título: The Elegant Universe
- Autor: Brian Greene
- Ano: 1999
- Categoria: Ciência

## A Ideia Central
Greene: strings, dimensões extra, relatividade, quântica. Universo estranho.

## Conceitos-Chave

**1. Conceito Principal**
Greene: strings, dimensões extra, relatividade, quântica. Fundação do tema.
