## Ficha Técnica
- Título: OAuth 2.0 Security
- Autor: Justin Richer & David Hardin
- Ano: 2019
- Categoria: Tecnologia

## A Ideia Central
OAuth2: delegue autenticação. User não compartilha password. App obtém token de escopa.

## Conceitos-Chave

**1. Conceito Principal**
OAuth2: delegue autenticação. Fundação do tema.
