## Ficha Técnica
- Título: Platform Revolution
- Autor: Geoffrey Parker et al.
- Ano: 2016
- Categoria: Negócios

## A Ideia Central
Plataforma conecta dois grupos. Uber = drivers + riders. Value em conexão.

## Conceitos-Chave

**1. Conceito Principal**
Plataforma conecta dois grupos. Fundação do tema.
