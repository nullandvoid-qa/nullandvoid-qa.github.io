window.TG_QAWAY_EN = {
  ...
  "courses": {
    ...
    "s2": {
      "title": "Lifecycle and Test Types"
    },
    "s3": {
    ...
    "s5": {
      "title": "BDD and Gherkin"
    },
    "s6": {
      "title": "Agile and Scrum for QAs"
    },
    "s7": {
      "title": "Day-to-Day Tools"
    },
    "s8": {
      "title": "Git for Testers"
    },
    "s9": {
      "title": "JavaScript for Testers"
    },
    "s10": {
      "title": "First Steps in Automation"
    },
    "s11": {
      "title": "Market and Career"
    },
    "s12": {
    ...
    "w2": {
      "title": "Cypress — Basic to Advanced"
    },
    "w3": {
      "title": "Playwright — Modern Automation"
    },
    "w4": {
      "title": "Selenium + Java"
    },
    "w5": {
      "title": "Robot Framework Web"
    },
    "w6": {
      "title": "CodeceptJS and TestCafé"
    },
    "w7": {
      "title": "Git and DevOps for Web QA"
    },
    "w8": {
    ...
    "a2": {
      "title": "Professional Postman"
    },
    "a3": {
      "title": "API Automation with JavaScript"
    },
    "a4": {
      "title": "Cypress and Playwright API"
    },
    "a5": {
    ...
    "a8": {
      "title": "GraphQL and WebSockets (intro)"
    },
    "a9": {
      "title": "API Final Project"
    },
    "m1": {
      "title": "Mobile QA Fundamentals"
    },
    "m2": {
      "title": "Appium — Setup and Concepts"
    },
    "m3": {
      "title": "WebdriverIO Mobile"
    },
    "m4": {
    ...
    "m6": {
      "title": "Mobile Performance and Battery"
    },
    "m7": {
      "title": "Mobile CI/CD"
    },
    ...
    "p4": {
      "title": "Analysis and Bottlenecks"
    },
    "p5": {
      "title": "Performance in Microservices"
    },
    "p6": {
    ...
    "p8": {
      "title": "Performance Final Project"
    },
    "sec1": {
    ...
    "dev3": {
      "title": "Reports and Observability"
    },
    "dev4": {
    ...
    "lead3": {
      "title": "Automation Architecture at Scale"
    },
    "lead4": {
      "title": "Leadership Final Project"
    }
  },
  "lessons": {
    "s1-l1": {
    ...
    "s1-l2": {
      ...
      "content": "<p><strong>QA (Quality Assurance)</strong> focuses on processes and prevention. <strong>QC (Quality Control)</strong> focuses on verification. <strong>Tester</strong> executes tests day to day.</p><p>In practice, companies mix these terms — what matters is understanding you can work in manual testing, automation, performance, security, and more.</p>"
    },
    "s1-l3": {
    ...
    "s2-l1": {
      ...
      "content": "<p>The software development lifecycle (SDLC) includes requirements, design, development, testing, deployment, and maintenance.</p><p>QA participates early: requirements review, sprint testing, staging validation, and post-production monitoring (shift-left).</p>"
    },
    "s2-l2": {
      "title": "Functional vs non-functional testing",
      "content": "<h3>Functional</h3><p>Validate what the system does: login, checkout, registration.</p><h3>Non-functional</h3><ul><li>Performance (speed under load)</li><li>Security</li><li>Usability</li><li>Accessibility</li><li>Compatibility</li></ul>"
    },
    "s2-l3": {
      "title": "Test levels: unit, integration, E2E",
      "content": "<p><strong>Unit:</strong> isolated functions (dev). <strong>Integration:</strong> modules together. <strong>System/E2E:</strong> full user flow (QA automation).</p><p>Test pyramid: many unit tests at the base, fewer E2E at the top — E2E is expensive but essential for critical flows.</p>"
    },
    "s3-l1": {
      "title": "Equivalence partitioning and boundary values",
      "content": "<p>Divide inputs into equivalence classes and test boundaries. Example: age field 18–65 → test 17, 18, 65, 66.</p>"
    },
    "s3-l2": {
      "title": "Decision tables and pairwise",
      "content": "<p>Decision tables map condition/action combinations. Pairwise testing reduces combinations while keeping reasonable coverage.</p>"
    },
    "s3-l3": {
      "title": "Exploratory testing",
      "content": "<p>Exploratory testing means learning, designing, and executing simultaneously. Use charters: \"Explore checkout with invalid card for 45 min\".</p>"
    },
    "s4-l1": {
      "title": "Test cases and plans",
      "content": "<p>Test case: precondition, steps, data, expected result. Test plan: scope, risks, schedule, entry/exit criteria.</p>"
    },
    "s4-l2": {
      "title": "How to report bugs professionally",
      "content": "<h3>Template</h3><ol><li>Clear title</li><li>Severity/Priority</li><li>Environment (OS, browser, version)</li><li>Steps to reproduce</li><li>Expected vs Actual</li><li>Evidence (screenshot, video, log)</li></ol>"
    },
    "s4-l3": {
      "title": "Traceability matrix",
      "content": "<p>Links requirements → test cases → bugs. Ensures coverage and simplifies audits.</p>"
    },
    "s5-l1": {
      "title": "Introduction to BDD",
      "content": "<p>Behavior-Driven Development aligns business, dev, and QA in user language. Tools: Cucumber, SpecFlow, Behave.</p>"
    },
    "s5-l2": {
      "title": "Writing Gherkin scenarios",
      "content": "<pre>Feature: Login\n  Scenario: Login with valid credentials\n    Given I am on the login page\n    When I enter correct email and password\n    And I click Sign in\n    Then I should see the dashboard</pre>"
    },
    "s5-l3": {
      "title": "Gherkin best practices",
      "content": "<p>Be declarative, not imperative. One scenario = one behavior. Avoid fragile UI details. Use Background and Scenario Outline when appropriate.</p>"
    },
    "s6-l1": {
      "title": "Agile ceremonies",
      "content": "<p>Sprint Planning, Daily, Review, Retrospective. QA participates by estimating tests, raising risks, and validating DoD (Definition of Done).</p>"
    },
    "s6-l2": {
      "title": "Three Amigos",
      "content": "<p>PO + Dev + QA refine stories together before development starts. Reduces rework and ambiguity.</p>"
    },
    "s6-l3": {
      "title": "QA in CI/CD",
    ...
    "s7-l2": {
      "title": "Postman and Insomnia (intro)",
      "content": "<p>Tools to explore APIs manually before automating. Collections, environments, basic assertions.</p>"
    },
    "s7-l3": {
      "title": "Browser DevTools",
      "content": "<p>Console, Network, Elements, Application. Essential for debugging front-end and understanding requests.</p>"
    },
    "s8-l1": {
      "title": "Concepts: commit, branch, merge",
      "content": "<p>Git versions code and tests. Core commands: clone, pull, checkout, add, commit, push, branch, merge.</p>"
    },
    "s8-l2": {
      "title": "Git workflow in teams",
      "content": "<p>Git Flow, trunk-based, PRs and code review. QA clones the test repo, creates a branch, opens a PR with new scenarios.</p>"
    },
    "s8-l3": {
      "title": "Resolving simple conflicts",
      "content": "<p>When merge fails, identify conflicts, pick the correct version, test, and commit the resolution.</p>"
    },
    "s9-l1": {
      "title": "Variables, types, and functions",
      "content": "<p>let/const, string, number, boolean, array, object. Arrow functions. Template literals. Foundation for Cypress and Playwright.</p>"
    },
    "s9-l2": {
      "title": "Async/await and Promises",
      "content": "<p>Web automation is asynchronous. Understand then/catch, async/await, and why tests must wait for elements.</p>"
    },
    "s9-l3": {
      "title": "Modules and npm basics",
      "content": "<p>package.json, npm install, scripts. How to run Cypress/Playwright via npm run test.</p>"
    },
    "s10-l1": {
      "title": "Why automate?",
      "content": "<p>Fast regression, continuous feedback, frees time for exploratory testing. Do not automate everything — prioritize critical, stable flows.</p>"
    },
    "s10-l2": {
      "title": "Selectors: CSS and data-testid",
      "content": "<p>Prefer data-testid and accessible roles. Avoid fragile position-based XPath. Page Object Model (POM) organizes selectors.</p>"
    },
    "s10-l3": {
    ...
    "s11-l2": {
      ...
      "content": "<p>GitHub with automation projects, clear README, CI badge, documented test cases. Blog or LinkedIn with learnings.</p>"
    },
    "s11-l3": {
      "title": "Interview preparation",
      "content": "<p>Study test types, write a bug report live, explain the pyramid, show automation code. Practice test system design.</p>"
    },
    "s12-l1": {
      "title": "Project: test a demo application",
      "content": "<p>Use practice sites: Swag Labs, ParaBank, The Internet (Herokuapp). Document 10 manual cases + 3 automated ones.</p>"
    },
    "s12-l2": {
    ...
    "w2-l1": {
      ...
      "content": "<pre>npx cypress open\ncy.visit('/login')\ncy.get('[data-cy=email]').type('user@test.com')\ncy.get('[data-cy=password]').type('123456')\ncy.get('[data-cy=submit]').click()</pre>"
    },
    "w2-l2": {
    ...
    "a1-l1": {
      ...
      "content": "<p>GET, POST, PUT, PATCH, DELETE. 2xx sucesso, 4xx cliente, 5xx servidor. Headers, body JSON, query params.</p>"
    },
    "a1-l2": {
    ...
    "a3-l2": {
      ...
      "content": "<pre>request(app).get('/users').expect(200).expect(res => {\n  expect(res.body).toHaveLength(10);\n});</pre>"
    },
    "a4-l1": {
    ...
    "a5-l1": {
      ...
      "content": "<pre>given().header(\"Auth\", token)\n  .when().get(\"/api/users\")\n  .then().statusCode(200)\n  .body(\"size()\", greaterThan(0));</pre>"
    },
    "a5-l2": {
    ...
    "m6-l1": {
      ...
      "content": "<p>Startup time, memory leaks, ANR, crash rate. Firebase Crashlytics.</p>"
    },
    "m7-l1": {
    ...
    "p2-l4": {
      ...
      "content": "<pre>jmeter -n -t plan.jmx -l results.jtl -e -o report/</pre>"
    },
    "p3-l1": {
      "title": "K6 scripts in JavaScript",
      "content": "<pre>import http from 'k6/http';\nexport default function() {\n  http.get('https://test.k6.io');\n}\nexport const options = { vus: 10, duration: '30s' };</pre>"
    },
    "p3-l2": {
    ...
    "sec1-l1": {
      ...
      "content": "<p>QA focuses on functionality and experience; security testing finds exploitable vulnerabilities. QAs with security skills are highly valued.</p><h3>Why QAs should learn security</h3><ul><li>Shift-left security prevents costly bugs</li><li>Compliance (GDPR, PCI-DSS) requires validation</li><li>Automate security checks in the pipeline</li></ul>"
    },
    "sec1-l2": {
      "title": "OWASP Top 10 — overview",
      "content": "<p>The 10 most critical web app vulnerabilities: Broken Access Control, Cryptographic Failures, Injection, Insecure Design, Security Misconfiguration, Vulnerable Components, Auth Failures, Integrity Failures, Logging Failures, SSRF.</p>"
    },
    "sec1-l3": {
      "title": "Basic threat modeling",
      "content": "<p>Identify assets, threats, and controls before coding. STRIDE: Spoofing, Tampering, Repudiation, Information Disclosure, DoS, Elevation of Privilege.</p>"
    },
    "sec2-l1": {
      "title": "SQL Injection — theory and testing",
      "content": "<p>Unsanitized inputs allow SQL query manipulation. Test with payloads like <code>' OR '1'='1</code>. Use legal environments like DVWA.</p>"
    },
    "sec2-l2": {
      "title": "Cross-Site Scripting (XSS)",
      "content": "<p>Reflected, Stored, and DOM-based XSS. Test inputs with script payloads. Validate encoding and Content-Security-Policy.</p>"
    },
    "sec2-l3": {
    ...
    "dev1-l1": {
      ...
      "content": "<p>Stages: checkout → install → lint → unit → integration → E2E → deploy. QA defines mandatory stages and failure criteria.</p>"
    },
    "dev1-l2": {
      "title": "GitHub Actions for tests",
      "content": "<pre>name: E2E\non: [pull_request]\njobs:\n  test:\n    runs-on: ubuntu-latest\n    steps:\n      - uses: actions/checkout@v4\n      - run: npm ci && npm test</pre>"
    },
    "dev1-l3": {
    ...
    "a11y1-l1": {
      ...
      "content": "<p>15%+ of the population has a disability. Laws (ADA, EAA in EU) require accessibility. It is quality, not an extra feature.</p>"
    },
    "a11y1-l2": {
    ...
    "a11y3-l1": {
      ...
      "content": "<pre>import { injectAxe, checkA11y } from 'axe-playwright';\ntest('a11y', async ({ page }) => {\n  await page.goto('/');\n  await injectAxe(page);\n  await checkA11y(page);\n});</pre>"
    },
    "a11y3-l2": {
      "title": "Lighthouse CI",
    ...
    "lead1-l1": {
      ...
      "content": "<p>Scope, risks, approaches by layer, tools, environments, entry/exit criteria, responsibilities. A living document, not shelfware.</p>"
    },
    "lead1-l2": {
    ...
    "lead3-l2": {
      ...
      "content": "<p>Quarantine, ownership, SLAs para fix, root cause categories. Zero tolerance para flaky na main branch.</p>"
    },
    "lead4-l1": {
